...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 17, 2026 at 04:03 AM
...
(7, '532323', 'albar', 1, 1, 2, '2026-03-17', 'Ada', NULL),
(8, '977878787', 'nazar', 1, 1, 1, '2026-03-17', 'Ada', NULL),
(9, '4435334', 'alfin', 1, 1, 1, '2026-03-17', 'Ada', NULL),
(10, '676754', 'hambali', 1, 1, 1, '2026-03-17', 'Ada', NULL);
...
(2, '0823412121412', 'Ahmad fauzi.Skom.Mkom.SHm.Dr', 'Kepala jaksa');
...
CREATE TABLE `pengguna` (
  ...
  `peran` enum('admin','pimpinan','staff') NOT NULL,
...
INSERT INTO `pengguna` (`id_pengguna`, `nama_pengguna`, `kata_sandi`, `nama_lengkap`, `peran`, `nip`, `divisi`) VALUES
(1, 'admin', '0192023a7bbd73250516f069df18b500', 'Administrator Sistem', 'admin', NULL, NULL),
(2, 'pimpinan', '7d3207a13dc221ac13c2f3dac3011f50', 'Kepala Pimpinan', 'pimpinan', NULL, NULL),
(3, 'staff', '1253208465b1efa876f982d8a9e73eef', 'ahmad fauzi', 'staff', '198001012005011001', 'Bidang Tindak Pidana Umum'),
(4, 'albar', '5517a36830276c36a99e869c4aaa6c27', 'Albar', 'staff', '21010101010', 'Bidang Tindak Pidana Khusus');
...
CREATE TABLE `transaksi_peminjaman` (
  ...
  `status` enum('Menunggu','Dipinjam','Menunggu Kembali','Kembali') DEFAULT 'Menunggu'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `transaksi_peminjaman` (`id_transaksi`, `id_pengguna`, `id_arsip`, `nama_peminjam`, `nip_peminjam`, `divisi`, `tanggal_pinjam`, `batas_kembali`, `tanggal_kembali`, `keterangan`, `sanksi`, `status`) VALUES
(4, 3, 6, 'Nazar', NULL, NULL, '2026-01-06', NULL, NULL, 'Keperluan sidang final', NULL, 'Dipinjam'),
(5, 3, 7, 'ahmad fauzi', '198001012005011001', 'Bidang Tindak Pidana Umum', '2026-03-17', '2026-06-17', '2026-03-17', 'contoh ajaaaa', 'Penurunan jabatan 1 tingkat (1 Thn)', 'Kembali');
...
--
ALTER TABLE `data_arsip`
  MODIFY `id_arsip` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `data_jaksa`
--
ALTER TABLE `data_jaksa`
  MODIFY `id_jaksa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `transaksi_peminjaman`
  ...
  ADD CONSTRAINT `transaksi_peminjaman_ibfk_2` FOREIGN KEY (`id_pengguna`) REFERENCES `pengguna` (`id_pengguna`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
